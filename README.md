...
A. Bye bye my iPhone, I'm sending you to your dad Tim Apple 
...
This project is based on Nathan (verygenericname)'s SSHRD_Script, please support him if you can! Link here: https://github.com/verygenericname/SSHRD_Script
...
4. A12/A13 devices is THEORETICALLY possible, but compatibility problems needs to be fixed. For A12 users and above, just keep your phone in your microwave isn't a bad idea.
